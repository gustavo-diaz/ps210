...
![](fig/sketchplanations-prospect-theory.jpg){fig-align="center" width=70%}
...
*Example:* Open list PR leads to legislative deadlock

::: incremental
- Only in presidential systems
- with high district magnitude
- without electoral thresholds
- and regionally concentrated parties
:::
